...
from pipeline.ai.common import MODEL
from pipeline.ai.demo_client import (
    _REPLAY_BT_IN_TOKENS,
    _REPLAY_BT_OUT_TOKENS,
    get_client,
    is_demo_mode,
)
...
def verify_translation(
    ...
    if is_demo_mode():
        return True, 0.9, "(demo) back-translated text", _REPLAY_BT_IN_TOKENS, _REPLAY_BT_OUT_TOKENS
