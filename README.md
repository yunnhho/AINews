...
- **데모**: https://ai-pulse-demo-nu.vercel.app
- **관리자(읽기 전용)**: https://ai-pulse-demo-nu.vercel.app/admin

공개 배포된 **읽기 전용** 데모입니다. 배치 파이프라인·번역 검증·비용 대시보드·한국어 검색을 실제 화면으로 확인할 수 있습니다. 데모 모드라 Claude API는 기록된 응답을 재생하므로 실제 비용은 **$0**이고, 모든 쓰기 작업은 비활성화되어 있습니다. (배포 방법: [`DEPLOY.md`](DEPLOY.md))
